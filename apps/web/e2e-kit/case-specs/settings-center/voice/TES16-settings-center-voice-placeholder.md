...
- 返回群聊后，输入框 placeholder 为“发送给 TES16 语音设置群”，不展示快捷键语音输入说明。
- 输入框有文字或为空时，均不展示快捷键语音说明。
- 不出现“设置未保存”或加载失败提示。

## 反例

- 若 ChatComposer 把快捷键说明拼入 placeholder，本 case 应失败。
...
- `packages/dmworkbase/src/i18n/locales/zh-CN.json`: placeholder 文案。
