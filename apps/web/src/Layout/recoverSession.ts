 ...
 * stays the enterprise standalone preflight's space-addressing param only. The caller adopts this
 * result IN MEMORY ONLY (never persists it) so a multi-bucket pick is never mirrored into the
 * cross-tab slot.
 */
