...
const CommentComposer = forwardRef<CommentComposerHandle, CommentComposerProps>(function CommentComposer(
  ...
  const labels = useMemo(
    () => ({
      ...
      members: t("loop.mention.groupMembers"),
      showMore: t("loop.mention.showMore"),
      searchMembersHint: t("loop.mention.searchMembersHint"),
      searchIssuesHint: t("loop.mention.searchIssuesHint"),
