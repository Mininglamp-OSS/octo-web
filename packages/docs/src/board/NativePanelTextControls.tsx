...
/** Mirrors Univer IFontService.isFontSupported so Board and Sheet communicate missing local fonts
 * with the same semantics. This only probes local browser fonts; it never downloads a font. */
