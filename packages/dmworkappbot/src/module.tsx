...
import { IModule, WKApp, Menus, t } from "@octo/base";
import AppBotPage from "./AppBotPage";
import { registerAppBotFoundation } from "./runtime/foundation";
  ...
  >
    <g transform="translate(1.66665 1.66665)" fill="currentColor">
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10.8333 0C9.91286 0 9.16667 0.746192 9.16667 1.66667V5.83333C9.16667 6.75381 9.91286 7.5 10.8333 7.5H15C15.9205 7.5 16.6667 6.75381 16.6667 5.83333V1.66667C16.6667 0.746192 15.9205 0 15 0H10.8333ZM10.8333 1.66667H15V5.83333H10.8333V1.66667Z"
      />
    </g>
  </svg>
);
