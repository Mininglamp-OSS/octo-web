...
export const settingsGroups: SettingsGroup[] = [
  ...
  { titleKey: "base.navRail.settingsCenter.group.privacySecurity", items: [{ id: "trusted-domains", labelKey: "base.navRail.settingsCenter.item.trustedDomains", capabilities: ["desktop"] }] },
  { titleKey: "base.navRail.settingsCenter.group.tools", items: [{ id: "shortcuts", labelKey: "base.navRail.settingsCenter.item.shortcuts" }, { id: "devices", labelKey: "base.navRail.settingsCenter.item.devices" }, { id: "runtimes", labelKey: "base.navRail.settingsCenter.item.runtimes" }, { id: "about", labelKey: "base.navRail.settingsCenter.item.about" }] },
];
