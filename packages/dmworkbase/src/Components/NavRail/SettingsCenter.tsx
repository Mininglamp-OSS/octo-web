...
import { Bell, FolderDown, Info, Keyboard, LogOut, Mic, Monitor, MonitorSmartphone, ServerCog, ShieldCheck, SlidersHorizontal, UserRound } from "lucide-react";
import { t } from "../../i18n";
...
const settingsIcons = { general: SlidersHorizontal, account: UserRound, notifications: Bell, voice: Mic, "desktop-behavior": Monitor, downloads: FolderDown, "trusted-domains": ShieldCheck, shortcuts: Keyboard, devices: MonitorSmartphone, runtimes: ServerCog, about: Info } as const;
